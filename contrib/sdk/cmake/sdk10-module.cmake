...
sdk10_def_option(SDK10_SW_VERSION sw_version.h)
cmake_path(ABSOLUTE_PATH SDK10_SW_VERSION BASE_DIRECTORY "${CMAKE_SOURCE_DIR}" NORMALIZE)
...
set(sdk10_image_default OFF)
function(sdk10_default_image_setup)
	if (DEFINED SDK10_IMAGE)
		return()
	endif()
	if (NOT EXISTS "${SDK10_SW_VERSION}")
		return()
	endif()
	set(sdk10_image_default ON PARENT_SCOPE)
endfunction()
sdk10_default_image_setup()
sdk10_def_option(SDK10_IMAGE "${sdk10_image_default}")
